...
attach(ConcJalisco) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcJalisco<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcJalisco) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcJalisco$factor,to.data.frame=TRUE)
...
ConcJalisco$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcJalisco$MAXT<-ConcJalisco$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcJalisco<-ConcJalisco[with(ConcJalisco, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcJalisco$ACUMULA<-cumsum(ConcJalisco$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcJalisco[dim(ConcJalisco[ConcJalisco$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcJalisco<-rbind(ConcJalisco[1:(dim(ConcJalisco[ConcJalisco$ACUMULA<tam_dec*i,])[1]+1),],
                      ConcJalisco[(dim(ConcJalisco[ConcJalisco$ACUMULA<tam_dec*i,])[1]+1):dim(ConcJalisco[1])[1],])
  
  b1<-tam_dec*i-ConcJalisco[dim(ConcJalisco[ConcJalisco$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcJalisco[(dim(ConcJalisco[ConcJalisco$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcJalisco[(dim(ConcJalisco[ConcJalisco$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcJalisco$ACUMULA2<-cumsum(ConcJalisco$factor)
...
ConcJalisco[(ConcJalisco$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcJalisco[((ConcJalisco$ACUMULA2>tam_dec*i)&(ConcJalisco$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}
...
write.dbf(c_DECIL_CV,file = "Jalisco por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Jalisco por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Jalisco por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_CV,file = "Jalisco INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Jalisco INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Jalisco INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_CV,file = "Jalisco NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Jalisco NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Jalisco NO por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_CV,file = "Jalisco Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Jalisco Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Jalisco Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_CV,file = "Jalisco INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Jalisco INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Jalisco INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_CV,file = "Jalisco NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Jalisco NO Ingresos por fuente por DECIL LI 2018.dbf")
...
setwd(c("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco"))

Deciles2010<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
GIC_Jalisco<-ggplotly(GIC_Jalisco)

GIC_Jalisco

saveWidget(GIC_Jalisco,fil="GIC_Jalisco_total.html")
...
Deciles_por_fuente_2010<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
names(deciles2018indigena)[1]<-c("Indigena2018")

deciles2010No<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
GIC_por_raza<-GIC_por_raza_derretida%>%
  ...
  labs(title = "Growth Incidence Curve Jalisco by ethnic group 2010-2018",
       fill="Ethnic group:",
       y="Growth rate (total)",
       x="Decile")+
...
saveWidget(GIC_por_raza,fil="GIC_Jalisco_by_ethnic_group.html")
...
Deciles_por_fuente_2010_indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco INDIGENA por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018_indigena<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
Deciles_por_fuente_2010_NO<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco NO por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018_NO<-read.dbf("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Jalisco/Jalisco/Jalisco NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
GIC<-ggplot()+
  ...
  geom_col(data = NO_melt, mapping=aes(x=as.numeric(Deciles)+0.15, y=value, fill= as.factor(variable), group=`Ethnic group`),
           width = 0.25)+
  labs(title = "Jalisco, Growth Incidence Curve by ethnic group, 2010-2018",
       y="Growth rate (total)",
       x="Decile",
...
saveWidget(GIC,fil="GIC_Jalisco_by_ethnic_group_and_source.html")
